package com.csb.support.settinghelper;
...
public class SettingUtility {
	...
	public static void setDefaultVoice(boolean status) {
		SettingHelper.setEditor(getContext(), "voice", status);
	}

	public static void setDefaultVibration(boolean status) {
		SettingHelper.setEditor(getContext(), "vibration", status);
	}

	public static void setDefault23GVoice(boolean status) {
		SettingHelper.setEditor(getContext(), "23GVoice", status);
	}

	public static boolean getDefaultVoice() {
		return SettingHelper.getSharedPreferences(getContext(), "voice", true);
	}

	public static boolean getDefaultVibration() {
		return SettingHelper.getSharedPreferences(getContext(), "vibration",
				true);
	}

	public static boolean getDefault23GVoice() {
		return SettingHelper.getSharedPreferences(getContext(), "23GVoice",
				true);
	}

	public static void setDefaultUserBean(UserBean userBean) {
		SettingHelper.setEditor(getContext(), "userid", userBean.getUserid());
		...
		SettingHelper.setEditor(getContext(), "departments",
				userBean.getDepartments());
		SettingHelper.setEditor(getContext(), "licenseimgurl",
				userBean.getLicenseimgurl());
		SettingHelper.setEditor(getContext(), "post", userBean.getPost());
		SettingHelper.setEditor(getContext(), "region", userBean.getRegion());
		SettingHelper.setEditor(getContext(), "phone", userBean.getPhone());
		SettingHelper.setEditor(getContext(), "mail", userBean.getMail());
		SettingHelper.setEditor(getContext(), "imageurl",
	...
	public static UserBean getDefaultUserBean() {
		String userid = SettingHelper.getSharedPreferences(getContext(),
				"userid", "");
		if (!TextUtils.isEmpty(userid)) {
			...
			userBean.setLicenseimgurl(SettingHelper.getSharedPreferences(
					getContext(), "licenseimgurl", ""));
			userBean.setDepartments(SettingHelper.getSharedPreferences(
					getContext(), "departments", ""));
			userBean.setGender(SettingHelper.getSharedPreferences(getContext(),
					"gender", ""));
			userBean.setHospital(SettingHelper.getSharedPreferences(
					getContext(), "hospital", ""));
			userBean.setImageurl(SettingHelper.getSharedPreferences(
					getContext(), "imageurl", ""));
			userBean.setMail(SettingHelper.getSharedPreferences(getContext(),
					"mail", ""));
			userBean.setPassword(SettingHelper.getSharedPreferences(
					getContext(), "password", ""));
			userBean.setPhone(SettingHelper.getSharedPreferences(getContext(),
					"phone", ""));
			userBean.setPost(SettingHelper.getSharedPreferences(getContext(),
					"post", ""));
			userBean.setRegion(SettingHelper.getSharedPreferences(getContext(),
					"region", ""));
	...
	public static boolean isFirstStart() {
		return SettingHelper.getSharedPreferences(getContext(), FIRSTSTART,
				true);

	}

	public static void setFirstStart(boolean status) {
		SettingHelper.setEditor(getContext(), FIRSTSTART, status);
	}
	...
	// .getSharedPreferences(getContext(),
	// SettingActivity.SHOW_COMMENT_REPOST_AVATAR,
	// true);
	// }
	//
	//
	...
	// return !SettingHelper
	// .getSharedPreferences(getContext(),
	// SettingActivity.DISABLE_DOWNLOAD_AVATAR_PIC,
	// false);
	// }
	//
	...
	// return SettingHelper
	// .getSharedPreferences(getContext(), SettingActivity.SHOW_BIG_AVATAR,
	// false);
	// }
	//
	...
	// return SettingHelper
	// .getSharedPreferences(getContext(),
	// SettingActivity.ENABLE_MENTION_COMMENT_TO_ME,
	// true);
	//
	// }
	//
	...
	// return SettingHelper
	// .getSharedPreferences(getContext(),
	// SettingActivity.DISABLE_HARDWARE_ACCELERATED,
	// false);
	//
	// }
	//
	...
	// .getSharedPreferences(getContext(), SettingActivity.UPLOAD_PIC_QUALITY,
	// "2");
	...
	// return SettingHelper
	// .getSharedPreferences(getContext(),
	// SettingActivity.ENABLE_INTERNAL_WEB_BROWSER,
	// true);
	//
	// }
	//
	...
	// return SettingHelper
	// .getSharedPreferences(getContext(),
	// SettingActivity.ENABLE_CLICK_TO_CLOSE_GALLERY,
	// true);
	//
	// }
