package com.csb.ui.view.switchbutton;
...
public class ViewHelper {
	...
	public static void showDialog(Context c, String title, String positiveHint,
			DialogInterface.OnClickListener pListener, String negativeHint,
	...
	public static void showDialog(Context c, String title, String positiveHint,
		...
		showDialog(c, title, null, positiveHint, pListener, null, null, null,
				null);
	}
